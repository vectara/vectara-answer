...
const DEFAULT_CONFIGS = {
  "vectara-docs": {
    ...
    search_title: "Ask Vectara Docs",
    search_description: "Ask anything about Vectara Docs",
  ...
  "vectara-website": {
    ...
    search_title: "Ask Vectara Website",
    search_description: "Ask anything about Vectara's Website",
    summary_default_language: "eng",
    summary_num_sentences: 3,
    summary_num_results: 7,
  ...
  "ask-feynman": {
    ...
    search_title: "Ask Feynman",
    search_description: "All of Richard Feynman's lectures",
    summary_default_language: "eng",
    summary_num_sentences: 3,
    summary_num_results: 7,

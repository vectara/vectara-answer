...
const DEFAULT_CONFIGS = {
  "vectara-docs": {
    ...
    searchTitle: "Ask Vectara Docs",
    searchDescription: "Ask anything about Vectara Docs",
  ...
  "vectara-website": {
    ...
    searchTitle: "Ask Vectara Website",
    searchDescription: "Ask anything about Vectara's Website",

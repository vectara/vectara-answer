      ...
      values: {
        ...
        description: {
          render: (
            <VuiText>
              <p>
                <strong>0–0.25.</strong> The answer is not grounded in the
      ...
      values: {
        ...
        description: {
          render: (
            <VuiText>
              <p>
                <strong>0.25–0.50.</strong> The answer is partially grounded in
      ...
      values: {
        ...
        description: {
          render: (
            <VuiText>
              <p>
                <strong>0.50–1.</strong> The answer is grounded in the retrieved
